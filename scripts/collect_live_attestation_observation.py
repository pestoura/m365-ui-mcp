...
from m365_mcp.attestation import AttestationLevel, observation_from_dict
from m365_mcp.attestation_collection import (  # shared with the worker runtime
    _selector_structural_shape,  # noqa: F401 - re-exported for existing digest-compat tests
    _structural_digest,  # noqa: F401 - re-exported for existing digest-compat tests
