...
| Operator-only GUI handoff is host-side, loopback-only, headed-container one-off, fail-closed | browser-worker, operator-gui-handoff; WORKER-120…135 | P-007, P-064 | preflight/teardown/rollback tests + loopback/CDP/chown/attest-allowlist/begin-signin-once assertion tests |
