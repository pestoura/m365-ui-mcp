...
| `pytest` | 519 passed (baseline on `main` @ e1c6b13: 483); the lane adds 36 assurance tests over the integration base, which advances during the concurrent Outlook chain |
