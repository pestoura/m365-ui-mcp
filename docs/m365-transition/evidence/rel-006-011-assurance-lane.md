...
| `pytest` | 558 passed (baseline on `main` @ fdf14cd: 522); the lane adds 36 assurance tests over the integration base, which advances during the concurrent Outlook chain |
