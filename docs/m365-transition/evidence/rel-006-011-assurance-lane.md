...
| `pytest` | 536 passed (baseline on `main` @ 5a0b668: 500); the lane adds 36 assurance tests over the integration base, which advances during the concurrent Outlook chain |
