...
primary-mailbox context verification, and OUT-006 adds a shared-mailbox scoped
context model. Outlook remains RESERVED and exposes no public MCP registrar or
browser operation surface.
"""
