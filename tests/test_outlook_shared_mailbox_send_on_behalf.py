...
def test_send_on_behalf_prepares_governed_non_executable_intent() -> None:
    drafts, intent, result = (
        shared_mailbox_send_on_behalf.prepare_shared_mailbox_send_on_behalf(
            _context(),
    ...
    assert drafts[0].from_identity_key == "delegated-alpha"
...
def test_send_on_behalf_fails_closed_for_wrong_mode_and_scope() -> None:
...
def test_out117_remains_reserved_and_not_public() -> None:
